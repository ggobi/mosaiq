...
mosaiq.theme <- function(name = c("lattice", "default", "trellis", "bw"))
{
    name <- match.arg(name)
    switch(name,
           default = mosaiq.custom.theme(),
           
           lattice = mosaiq.custom.theme(col = c("#0080ff", "#ff00ff", "darkgreen", "#ff0000", "orange", "#00ff00", "brown"),
           ...
           trellis = mosaiq.custom.theme(col = c("#00FFFF", "#FF00FF", "#00FF00", "#FF7F00", "#007EFF", "#FFFF00", "#FF0000"),
           ...
           bw = mosaiq.custom.theme(col = c("#000000", "#000000", "#000000", "#000000", "#000000", "#000000", "#000000"),
             ...
             fg = "black")
{
    ...
    theme <-
        list(default         = list(col = col, fill = "transparent", lty = 1, lwd = 0),
             ...
             axis            = list(col = fg, family = family, pointsize = pointsize),
